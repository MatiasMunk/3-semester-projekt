...
CREATE TABLE StudySessions (
    ...
    CONSTRAINT CK_StudySessions_MaxParticipants_Positive CHECK (MaxParticipants > 0),
    CONSTRAINT CK_StudySessions_CurrentParticipants_Valid CHECK (CurrentParticipants >= 0 AND CurrentParticipants <= MaxParticipants)
...
CREATE INDEX IX_SessionParticipants_SessionId
...
CREATE TABLE SavedSessions (
    ...
    CONSTRAINT UQ_Saved UNIQUE (UserId, SessionId)
);
...
/* =========================================================
   OPTIONAL: TAGS (future scalability)
   ========================================================= */
CREATE TABLE Tags (
    Id INT PRIMARY KEY IDENTITY,
