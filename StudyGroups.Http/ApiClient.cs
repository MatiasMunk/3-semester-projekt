...
public class ApiClient
{
    ...
    public ApiClient(string baseUrl, bool trustDevCert = false, string? adminApiKey = null)
    {
        if (string.IsNullOrWhiteSpace(baseUrl))
            throw new ArgumentException("Base URL cannot be null or empty.", nameof(baseUrl));

        // trustDevCert = true skips SSL validation for the self-signed
        // localhost certificate generated by `dotnet dev-certs https --trust`.
        ...
        if (!string.IsNullOrWhiteSpace(adminApiKey))
            _http.DefaultRequestHeaders.Add("X-Admin-Key", adminApiKey);
    }
